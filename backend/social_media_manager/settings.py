...
if 'RAILWAY_ENVIRONMENT' in os.environ:
    ALLOWED_HOSTS.append('*')  # Railway handles SSL termination
...
AUTH_PASSWORD_VALIDATORS = [
    ...
    {
        "NAME": "apps.core.validators.SafeCommonPasswordValidator",
    },
    {
...
STRIPE_PUBLISHABLE_KEY = config("STRIPE_PUBLISHABLE_KEY", default="pk_test_51S2qAwJGjEytaWB9qHfZ5QCjDAMacPPYu8yFTHvQAqReuqnncq31AJiqATbriiU7xPJ9qGteTIc5Z5Wk0L933Cmm00kIT2kdHp")
STRIPE_SECRET_KEY = config("STRIPE_SECRET_KEY", default="sk_test_51S2qAwJGjEytaWB9ncbaGu5i01XYyxcqLYAlmAtIMYwnHbXJXJob43lbT4cctu44L2bRebGZK8MGfScZKahYUpEI00Bp2bx9Z2")
