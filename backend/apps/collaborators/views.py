...
class PostCollaborationView(generics.RetrieveUpdateAPIView):
    ...
    def get_object(self):
        ...
        if post.user != self.request.user:
            ...
            collaborations = PostCollaboration.objects.filter(
                post=post, 
...
class ReviewListCreateView(generics.ListCreateAPIView):
    ...
    def get_queryset(self):
        ...
        if collaboration.post.user != self.request.user and not collaboration.reviewers.filter(id=self.request.user.id).exists():
