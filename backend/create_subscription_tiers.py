    ...
    tiers = [
        {
            ...
            'price_yearly': Decimal('79.99'),  # 10 months price for yearly
        ...
        },
        {
            ...
            'description': 'For large businesses and agencies with advanced needs',
            'price_monthly': Decimal('19.99'),
            'price_yearly': Decimal('199.99'),  # 10 months price for yearly
